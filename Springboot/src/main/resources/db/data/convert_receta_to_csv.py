#!/usr/bin/env python3
# Script to convert MySQL dump INSERT INTO `receta` into a CSV for Postgres COPY
import re
import csv
from pathlib import Path

ROOT = Path(__file__).resolve().parent
INPUT = ROOT.parent.parent.parent.parent.parent / 'Base de datos a instalar' / 'recetas-ejemplo.sql'
OUTPUT = ROOT / 'receta.csv'
