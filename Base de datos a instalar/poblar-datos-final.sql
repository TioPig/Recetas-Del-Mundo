...
-- INSERT de datos corregido (sin columna estado en usuario)

-- Insertar usuarios primero (sin columna estado que no existe)
INSERT INTO usuario (id_usr, nombre, apellido, password, fecha_creacion, id_pais) VALUES
(1, 'Admin', 'Sistema', '$2a$10$encryptedpassword', '2025-08-30 17:50:00', NULL),
(2, 'Chef', 'Latino', '$2a$10$encryptedpassword', '2025-08-30 17:50:00', NULL),
(3, 'Usuario', 'Prueba', '$2a$10$encryptedpassword', '2025-08-30 17:50:00', NULL);
