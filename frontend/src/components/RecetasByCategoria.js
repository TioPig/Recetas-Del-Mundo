...
import { getRecetasByCategoria, getCategoria, postLikeReceta, postStarReceta, postFavoritoReceta, getComentariosReceta, postComentarioReceta, isAuthenticated } from '../api';
          ...
          <DialogContent dividers>
            ...
            <List>
              {(selectedReceta?.ingredientes || []).map(i=> (
                <ListItem key={i.idIngrediente}><ListItemText primary={i.nombre} /></ListItem>
              ))}
            </List>
